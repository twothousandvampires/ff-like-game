...
export class Battleground{
        ...
        static plan = []
            ...
            static newBattle(enemy, player){
                ...
                addEventListener('mouseup' , down_listener)
            ...
            static enemyTurn(){
                ...
                if(Battleground.timer === 200){
                    if(Battleground.enemyStack.enemy[Battleground.i].act(Battleground.player)){
                    ...
                    Battleground.timer += 20
                }
                if(Battleground.i === Battleground.enemyStack.enemy.length){
